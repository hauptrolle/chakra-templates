...
export default function imageWithTextAndCTA(){
  return (
    <Box w={"100vw"} pos={"relative"}>
      ...
      <VStack align={"start"} pos={"absolute"} top={"0"} h={"100%"} justifyContent={"between"} spacing={"1.5rem"} left={"3.5rem"} bg={"linear-gradient(to right, rgba(49, 130, 206, 0.5) 50%, rgba(49, 130, 206, 0) 65%)"}>
