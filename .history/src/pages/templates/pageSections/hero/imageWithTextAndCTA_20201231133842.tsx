...
export default function imageWithTextAndCTA(){
  const mdAndLg = true;
  const hVariant = useBreakpointValue({ base: "250px", md: "400px" })
  const s = useBreakpointValue({ base: "250px", md: "400px" })
  const sBtnvariant = useBreakpointValue({ base: "250px", md: "400px" })
  return (
