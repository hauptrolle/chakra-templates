...
export default function imageWithTextAndCTA(){
  return (
    <Box w={"100vw"} pos={"relative"}>
      ...
      <VStack align={"start"} pos={"absolute"} top={"0"} h={"100%"} justifyContent={"center"} spacing={"1.5rem"} pl={"3.5rem"} bg={"linear-gradient(to right, rgba(49, 130, 206, 0.5) 70%, rgba(49, 130, 206, 0) 65%)"}>
